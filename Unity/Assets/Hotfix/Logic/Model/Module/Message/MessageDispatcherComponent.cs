...
namespace ET
{
	...
	public class MessageDispatcherComponent : Entity
	{
		...
		public void Load()
		{
			...
			ET.MessageDispatcherComponent messageDispatcherComponent = ET.Game.Scene.GetComponent<ET.MessageDispatcherComponent>();
			ET.OpcodeTypeComponent opcodeTypeComponent = ET.Game.Scene.GetComponent<ET.OpcodeTypeComponent>();
		...
		public void Handle(ET.Session session, MessageInfo messageInfo)
		{
