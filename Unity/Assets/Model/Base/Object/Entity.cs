...
namespace ET
{
	...
	public partial class Entity : Object
	{
		...
		public bool RemoveChild(Entity entity)
		{
			...
			bool ret =this.children.Remove(entity.Id);
        ...
        public K GetOrAddComponent<K>() where K : Entity, new()
        {
			var k = GetComponent<K>();
			if (k == null)
				k = AddComponent<K>();
            return k;
        }
		...
		public void RemoveComponent<K>(bool isDestroy =true) where K : Entity
		{
			if (this.IsDisposed)
			{
				return;
