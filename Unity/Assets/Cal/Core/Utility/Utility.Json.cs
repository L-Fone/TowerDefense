        ...
        public static partial class Json
        {
            ...
            public static string ToJson(object obj)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    throw new System.Exception(Text.Format("Can not convert to JSON with exception '{0}'.", exception.ToString()), exception);
                }
            }
            ...
            public static T ToObject<T>(string json)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    throw new System.Exception(Text.Format("Can not convert to object with exception '{0}'.", exception.ToString()), exception);
                }
            }
            ...
            public static object ToObject(Type objectType, string json)
            {
                ...
                if (objectType == null)
                {
                    throw new System.Exception("Object type is invalid.");
                }
